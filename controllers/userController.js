...
class UserController {
    static userRegistration = async (req, res) => {
      const {name, email, password, password_confirmation, tc} = req.body  
        ...
        if(user){
            res.status({"status": "failed", "message":"Email already exists"})
        }else{
            ...
            if(email && password){
                ...
                if(user != null){
                    ...
                    if ((user.email === email) && isMatch) {
                        ...
                        res.send({"status": "failed", "message":"Password or Email is incorrect"})
                    }
                } else {
    ...
    static ResetUserPasswordbySendEmail = async(req, res) => {
    ...
    static userPasswordReset = async(req, res) => {
        ...
        try {
            ...
            if(password && password_confirmation){
                ...
                res.send({"status": "failed", "message":"All Fields is Required."})
            }
        } catch (error) {
